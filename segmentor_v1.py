...
class DenseNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_pool_first = nn.Conv3d(num_init_features,
                                         num_init_features,
                                         kernel_size=2,
                                         stride=2,
                                         padding=0,
        ...
        for i, num_layers in enumerate(block_config):
            ...
            up_block = nn.ConvTranspose3d(num_features,
                                          num_classes,
                                          kernel_size=2**(i + 1) + 2,
                                          stride=2**(i + 1),
                                          padding=1,
        ...
        self.conv_class = nn.Conv3d(num_classes * 4 + num_init_features,
                                    num_classes,
                                    kernel_size=1,
                                    padding=0)
        # ----------------------------------------------------------
    ...
    def forward(self, x):
        ...
        #
        out = torch.cat(
            [up_block1, up_block2, up_block3, up_block4, first_three_features],
            1)
